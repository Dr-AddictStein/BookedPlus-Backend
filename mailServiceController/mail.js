...
export const sendWelcomeEmail = async (to, fullName) => {
  ...
  const emailContent = `
    ...
    <p>We look forward to providing you with a seamless and efficient online catering reservation experience. In the meantime, feel free to visit BookedPlus Learn where we regularly post blogs about the benefits of switching to an online reservation platform while still keeping phone reservations available.</p>
